...
|SSDF|[Blocklist Packages](#slsa)|Prevent risky packages in the artifact.|
|SSDF|[Fresh Artifact](#slsa)|Verify an artifact's freshness.|
|SSDF|[Fresh Image](#slsa)|Ensure an image freshness.|
|SLSA, SSDF|[Verify Image Lables/Annotations](#slsa)|Ensure image has required labels (e.g., git-commit).|
